...
return [
    ['label' => 'Main', 'items' => [
        ...
        ['label' => 'Branch Students Admin', 'route' => 'super-admin.students.index', 'active' => ['super-admin.students.index', 'super-admin.students.edit', 'super-admin.students.show'], 'icon' => 'students'],
