...
class HomepageItemSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $items = [
            ...
            'hero' => [
                ['key' => 'hero-lab', 'title' => 'Empowering South Asia\'s Tech Leaders. Building a Secure Future.', 'subtitle' => 'South Asia National Technical Institute', 'body' => 'Industry-focused technical training, experienced mentors, and nationwide opportunity—designed to turn ambition into employable expertise.', 'image' => 'images/bnyti-hero-premium-1.png', 'link_label' => 'Join Course', 'link_url' => '#courses'],
                ['key' => 'hero-workshop', 'title' => 'Build confidence through hands-on learning.', 'subtitle' => 'South Asia National Technical Institute', 'body' => 'Modern laboratories and project-based classes help learners build skills they can use from day one.', 'image' => 'images/bnyti-hero-premium-2.png', 'link_label' => 'Explore Courses', 'link_url' => '#courses'],
                ['key' => 'hero-design', 'title' => 'Your next opportunity starts here.', 'subtitle' => 'South Asia National Technical Institute', 'body' => 'Join a supportive technical education community and prepare for a changing world of work.', 'image' => 'images/bnyti-hero-premium-3.png', 'link_label' => 'Contact Us', 'link_url' => '#latest-news-contact'],
            ],
            'trust' => [
