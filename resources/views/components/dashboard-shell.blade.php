            ...
            <aside class="border-b border-slate-200 bg-white lg:fixed lg:inset-y-0 lg:left-0 lg:z-20 lg:w-72 lg:border-b-0 lg:border-r">
                ...
                <nav aria-label="Super Admin navigation" class="max-h-[calc(100vh-5.5rem)] overflow-y-auto px-3 py-4 lg:px-4">
                    ...
                    <a href="{{ route('super-admin.courses.index') }}" @class(['mb-1 flex items-center gap-3 rounded-xl px-3 py-3 text-sm font-bold transition', 'bg-blue-50 text-blue-700' => request()->routeIs('super-admin.courses.*'), 'text-slate-600 hover:bg-blue-50 hover:text-blue-700' => ! request()->routeIs('super-admin.courses.*')])>
                        <svg viewBox="0 0 24 24" class="size-5 fill-none stroke-current" stroke-width="1.8"><path d="M4 5.5A2.5 2.5 0 0 1 6.5 3H12v17H6.5A2.5 2.5 0 0 0 4 22z"/><path d="M20 5.5A2.5 2.5 0 0 0 17.5 3H12v17h5.5a2.5 2.5 0 0 1 2.5 2z"/></svg> Course List
                    </a>
                    <details class="group mt-1 rounded-xl" @if (request()->routeIs('super-admin.students.documents.*')) open @endif>
                        ...
                        <div class="ml-6 grid border-l border-blue-100 py-1 pl-4 text-sm"><span class="py-2 text-slate-400">Admit Card</span><span class="py-2 text-slate-400">Certificate</span><span class="py-2 text-slate-400">Transcript & Results</span></div>
                    </details>
                </nav>
