<x-dashboard-shell :title="$course->name" eyebrow="Course details" :description="$course->description ?: 'No course description has been added.'">
    <article class="rounded-2xl border border-slate-200 bg-white p-6 shadow-lg shadow-slate-900/5 sm:p-8">
        ...
        <dl class="grid gap-6 sm:grid-cols-3">
            <div><dt class="text-xs font-black uppercase tracking-[0.14em] text-slate-500">Course code</dt><dd class="mt-2 text-lg font-black text-slate-950">{{ $course->code }}</dd></div>
