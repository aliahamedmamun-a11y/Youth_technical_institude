<x-dashboard-shell title="Notice Board Add">
    <div class="mx-auto max-w-2xl py-10">
        <div class="rounded-[2rem] border border-white/20 bg-[#1e293b] p-10 shadow-2xl backdrop-blur-sm lg:p-14" style="background-color: #1a2c3d;">
            ...
            <div class="mb-10 text-center">
                <h1 class="text-3xl font-black text-slate-400 uppercase tracking-tight" style="color: #4a5568;">Notice Board Add</h1>
            </div>

            <form action="{{ route('super-admin.notice-board-suggestions.store') }}" method="POST" class="space-y-8">
                @csrf
                ...
                <div>
                    ...
                    <textarea name="suggestion" rows="6" required placeholder="How can we improve the exam or system?"
