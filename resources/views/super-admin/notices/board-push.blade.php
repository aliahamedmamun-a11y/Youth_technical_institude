<x-dashboard-shell title="Notice Board Push">
    <div class="mx-auto max-w-[1600px] space-y-10">
        ...
        <div class="text-center">
            ...
            <p class="mt-4 text-sm font-bold text-slate-500 uppercase tracking-widest">
                প্রশাসকের কাছে প্রেরিত বার্তাগুলি দেখুন, সম্পাদনা করুন এবং নতুন নোটিশ যুক্ত করুন।
            </p>
        </div>
        ...
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            @empty
                <div class="col-span-full py-32 text-center">
                    <p class="text-lg font-black text-slate-600 uppercase tracking-[0.3em]">No notices to push</p>
                </div>
            @endforelse
        </div>
    </div>
